...
import com.plentra.sphereclient.Home.GetHome;
import com.plentra.sphereclient.Home.GetHomeLoadMore;
import com.plentra.sphereclient.Home.HomeItems;
import com.plentra.sphereclient.Item.GetItem;
import com.plentra.sphereclient.Items.GetItems;
import com.plentra.sphereclient.Items.GetItemsLoadMore;
import com.plentra.sphereclient.Items.Items;
import com.plentra.sphereclient.Launcher.GetLauncher;
import com.plentra.sphereclient.Launcher.GetLauncherLoadMore;
import com.plentra.sphereclient.Launcher.LauncherItems;
...
//    }
    ...
    public void getItem(GetItem getItem , String itemId) {
        getItem.onLoading();
        String url = "https://api.plentratechnologies.com/?action=getItem&appKey="+APP_KEY+"&itemId="+itemId;
    ...
    public void getItemsLoadMore(GetItemsLoadMore getItemsLoadMore , String itemCategoryId){
        ...
        String url = "https://api.plentratechnologies.com/?action=getItems&appKey="+APP_KEY+"&page="+itemsPageNumber+"&categoryId="+itemCategoryId;
        new VolleyGet(context, url, new Fetch() {
            @Override
            public void getData(String response) {
    ...
    public void getItems(GetItems getItems , String itemCategoryId){
       itemsPageNumber = 1 ;
        getItems.onLoading();
        String url = "https://api.plentratechnologies.com/?action=getItems&appKey="+APP_KEY+"&page=1&categoryId="+itemCategoryId;
        new VolleyGet(context, url, new Fetch() {
            @Override
            public void getData(String response) {
    ...
    public void getLauncherLoadMore(GetLauncherLoadMore getLauncherLoadMore , String launcherId){
       launcherPageNumber++;
        ...
        String url = "https://api.plentratechnologies.com/?action=getLauncher&appKey="+APP_KEY+"&page="+launcherPageNumber+"&launcherId="+launcherId;
        new VolleyGet(context, url, new Fetch() {
            @Override
            public void getData(String response) {
    ...
    public void getLauncher(GetLauncher getLauncher , String launcherId){
       launcherPageNumber = 1;
        ...
        String url = "https://api.plentratechnologies.com/?action=getLauncher&appKey="+APP_KEY+"&page=1&launcherId="+launcherId;
        new VolleyGet(context, url, new Fetch() {
            @Override
            public void getData(String response) {
    ...
    public void getHomeLoadMore(GetHomeLoadMore getHomeLoadMore){
       ...
       getHomeLoadMore.onLoading();
        String url = "https://api.plentratechnologies.com/?action=getHome&appKey="+APP_KEY+"&page="+homePageNumber;
        new VolleyGet(context, url, new Fetch() {
            @Override
            public void getData(String response) {
    ...
    public void getHome(GetHome home){
        home.onLoading();
        String url = "https://api.plentratechnologies.com/?action=getHome&appKey="+APP_KEY+"&page=1";
            new VolleyGet(context, url, new Fetch() {
                @Override
                public void getData(String response) {
                    home.onLoadfinished();
